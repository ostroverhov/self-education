...
public class SqlQueries {
    ...
    public static String getQueryAddTest(String idProject, TestModel testModel) {
        String query = String.format(queryAddTest, testModel.getName(), testModel.getStatus(), testModel.getMethod(), idProject, testModel.getStartTime(), testModel.getEndTime(), testModel.getEnvironment(), testModel.getBrowser());
    ...
    public static String getQueryAddLog(String pathToLogFile, String idTest) throws IOException {
        String query = String.format(queryAddLog, ReaderUtils.readFile(pathToLogFile), idTest);
    ...
    public static String getQueryAddScreenshot(String pathToScreenShot, String idTest) throws IOException {
        String query = String.format(queryAddScreenshot, ScreenShotUtils.screenShotToString(pathToScreenShot), idTest);
